...
//Fetch all products
$productList = $conn->query("SELECT * FROM products ORDER BY Product_Name");
?>
                ...
                <div class="form-group">
                    ...
                    <select name="product_id" id="product_id" required>
                        ...
                        <?php while ($row = $productList->fetch_assoc()): ?>
                            <option value="<?= $row['Product_ID'] ?>"><?= htmlspecialchars($row['Product_Name']) ?> (Current: <?= $row['Product_Stock'] ?>)</option>
                        <?php endwhile; ?>
                    </select>
                </div>
